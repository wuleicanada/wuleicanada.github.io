...
var G__27263 = o;
goog.object.set(G__27263,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__27309__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__27309 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__27310__i = 0, G__27310__a = new Array(arguments.length -  0);
while (G__27310__i < G__27310__a.length) {G__27310__a[G__27310__i] = arguments[G__27310__i + 0]; ++G__27310__i;}
  args = new cljs.core.IndexedSeq(G__27310__a,0,null);
} 
return G__27309__delegate.call(this,args);};
G__27309.cljs$lang$maxFixedArity = 0;
G__27309.cljs$lang$applyTo = (function (arglist__27311){
var args = cljs.core.seq(arglist__27311);
return G__27309__delegate(args);
});
...
var G__27265 = o;
goog.object.set(G__27265,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__27312__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
var G__27269 = props;
var G__27269__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27269,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27269);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27269__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__27269__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__27270 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27270,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__27270;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__27276){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27277__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__27280_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__27280_SHARP_);
}));
} else {
return null;
}
...
var vec__27282 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27282,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27282,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27282,(2),null);
...
var temp__5739__auto___27338 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___27338 == null)){
} else {
var key_27339 = temp__5739__auto___27338;
(jsprops.key = key_27339);
}
...
var temp__5739__auto___27340 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___27340 == null)){
} else {
var key_27341 = temp__5739__auto___27340;
(jsprops.key = key_27341);
}
...
var G__27288 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__27288) : reagent.impl.template.as_element.call(null,G__27288));
} else {
var temp__5739__auto___27342 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___27342 == null)){
} else {
var key_27343 = temp__5739__auto___27342;
(jsprops.key = key_27343);
}
...
args__4736__auto__.push((arguments[i__4731__auto___27345]));
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27291){
var G__27292 = cljs.core.first(seq27291);
var seq27291__$1 = cljs.core.next(seq27291);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27292,seq27291__$1);
}));
...
break;
default:
var G__27348 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__27348;
continue;
...
var ctx = ({});
var vec__27295 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27295,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27295,(1),null);
...
var G__27298 = (cljs.core.count(argv) - first_child);
switch (G__27298) {
case (0):
