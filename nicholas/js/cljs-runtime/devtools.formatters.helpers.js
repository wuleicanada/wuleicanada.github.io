...
var G__29909 = devtools.prefs.pref(v);
v = G__29909;
continue;
} else {
return v;
...
}catch (e29861){var _e__27201__auto__ = e29861;
return false;
}})();
...
}catch (e29874){var _e__27201__auto__ = e29874;
return false;
}})();
...
}catch (e29876){var _e__27201__auto__ = e29876;
return false;
}}
}
});
...
var vec__29884 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29884,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29884,(1),null);
...
return cljs.core.some((function (p1__29894_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29894_SHARP_);
}),template);
});
