...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__27331){
...
var vec__27339 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27339,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27339,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27339,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_27421 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27421(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27422 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27422(a,b);
}
});
...
var fexpr__27409 = (function (){var G__27410 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27410__$1)].join('')));

}
})();
return (fexpr__27409.cljs$core$IFn$_invoke$arity$2 ? fexpr__27409.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__27409.call(null,a,b));
}));
/**
