...
var o29423 = temp__5733__auto__;
var temp__5733__auto____$1 = (o29423["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o29424 = temp__5733__auto____$1;
return (o29424["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27189__auto__ = f;
return (o__27189__auto__["toString"]).call(o__27189__auto__);
} else {
return "";
}
}catch (e29425){var _ = e29425;
return "";
}});
...
try{var o__27189__auto___29816 = t;
(o__27189__auto___29816["cljs$lang$ctorPrWriter"]).call(o__27189__auto___29816,t,writer);
}catch (e29472){var __29817 = e29472;
}
...
var char_code = (function (){var o__27189__auto__ = (new String(char$));
return (o__27189__auto__["charCodeAt"]).call(o__27189__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27189__auto__ = String;
return (o__27189__auto__["fromCharCode"]).call(o__27189__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29477 = num_code;
switch (G__29477) {
case (1):
return (185);
...
var o__27189__auto__ = String;
return (o__27189__auto__["fromCharCode"]).call(o__27189__auto__,superscript_code);
});
/**
...
}catch (e29503){var _e__27201__auto__ = e29503;
return false;
}})())){
...
var vec__29504 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29504,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29531){
var vec__29532 = p__29531;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29532,(0),null);
...
var G__29842 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29843 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29842;
remaining_tokens = G__29843;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29526){
var G__29527 = cljs.core.first(seq29526);
var seq29526__$1 = cljs.core.next(seq29526);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29527,seq29526__$1);
}));
...
var vec__29552 = cljs.core.split_with((function (p1__29551_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29551_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29552,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29552,(1),null);
...
var vec__29559 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29559,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29559,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29846 = cljs.core.rest(remaining_tokens);
var G__29847 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29846;
name_tokens = G__29847;
continue;
} else {
...
var vec__29578 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29578,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29578,(1),null);
var vec__29581 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29581,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29581,(1),null);
var vec__29584 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29584,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29584,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29584,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29584,(3),null);
...
var vec__29592 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29592,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29592,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29592,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29592,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29592,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29592,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__29609 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29609,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29609,(1),null);
var vec__29613 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29613,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29613,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29621 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29621) : devtools.munging.parse_fn_info_deep.call(null,G__29621));
})()));
}
} else {
return fn_info;
...
var G__29882 = (arity + (1));
var G__29883 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29637){
var vec__29638 = p__29637;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29638,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29638,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29654_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29654_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29655_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29655_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29666){
var vec__29670 = p__29666;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29670,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29659){
var G__29660 = cljs.core.first(seq29659);
var seq29659__$1 = cljs.core.next(seq29659);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29660,seq29659__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29677__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29677__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29677__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29677__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29678 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29678,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29678,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29678,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29678,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29678,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29678,(5),null);
...
var o__27189__auto__ = f;
return (o__27189__auto__["getBasis"]).call(o__27189__auto__);
});
/**
...
}catch (e29686){var _e__27201__auto__ = e29686;
...
var G__29912 = (obj[cljs.core.first(path)]);
var G__29913 = cljs.core.rest(path);
obj = G__29912;
path = G__29913;
continue;
} else {
...
var _STAR_ = (function (accum,p__29733){
var vec__29734 = p__29733;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29734,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29734,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29739){
var vec__29742 = p__29739;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29742,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29742,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29742,(2),null);
...
var post_process = (function (p__29754){
var vec__29755 = p__29754;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29755,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29755,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29752_SHARP_){
return (obj[cljs.core.first(p1__29752_SHARP_)]);
}),sorted_matches);
