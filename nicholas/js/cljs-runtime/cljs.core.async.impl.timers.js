...
var i_32779 = (0);
while(true){
if((i_32779 < arr.length)){
(arr[i_32779] = null);

var G__32781 = (i_32779 + (1));
i_32779 = G__32781;
continue;
} else {
}
...
var i_32795 = (self__.level + (1));
while(true){
if((i_32795 <= (new_level + (1)))){
(update[i_32795] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32797 = (update[i]).forward;
(x__$2.forward[i] = (links_32797[i]));
...
var i_32800 = (0);
while(true){
if((i_32800 <= self__.level)){
var links_32801 = (update[i_32800]).forward;
if((x__$1 === (((i_32800 < links_32801.length))?(links_32801[i_32800]):null))){
(links_32801[i_32800] = (x__$1.forward[i_32800]));

var G__32802 = (i_32800 + (1));
i_32800 = G__32802;
continue;
} else {
var G__32804 = (i_32800 + (1));
i_32800 = G__32804;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__32821 = nx;
var G__32822 = (level__$1 - (1));
x = G__32821;
level__$1 = G__32822;
continue;
} else {
var G__32823 = x;
var G__32824 = (level__$1 - (1));
x = G__32823;
level__$1 = G__32824;
continue;
}
