...
if((i < len)){
var k = (ks[i]);
var G__27261 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__27262 = (i + (1));
m = G__27261;
i = G__27262;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27169 = c;
var G__27169__$1 = (((G__27169 == null))?null:G__27169.prototype);
if((G__27169__$1 == null)){
return null;
} else {
return G__27169__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27172 = c;
var G__27172__$1 = (((G__27172 == null))?null:G__27172.prototype);
if((G__27172__$1 == null)){
return null;
} else {
return G__27172__$1.render;
}
})() == null)))));
});
...
var G__27181 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__27181) : reagent.impl.component.as_element.call(null,G__27181));
};
...
var G__27182 = c;
var G__27182__$1 = (((G__27182 == null))?null:G__27182.constructor);
if((G__27182__$1 == null)){
return null;
} else {
return G__27182__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__27185 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27186 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27186);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27185);
}});
...
var c = this;
var G__27196_27279 = goog.object.get(c,"cljsRatom");
if((G__27196_27279 == null)){
} else {
reagent.ratom.dispose_BANG_(G__27196_27279);
}
...
var renders_27286 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_27287 = cljs.core.first(cljs.core.vals(renders_27286));
...
if((cljs.core.count(renders_27286) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_27286))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_27287)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_27287], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__27233 = o;
goog.object.set(G__27233,cljs.core.name(k),v);
