...
}catch (e27292){var _e = e27292;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___27302 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___27302)){
var seen_errors_27303 = temp__5733__auto___27302;
if(cljs.core.truth_(seen_errors_27303.has(self))){
} else {
seen_errors_27303.add(self);

var temp__5735__auto___27304 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___27304)){
var sense_27305 = temp__5735__auto___27304;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27305)].join(''));
} else {
}
}
} else {
