...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30166){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30167,G__30168,seq30166__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30181_SHARP_){
return (!((cljs.core.meta(p1__30181_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30188__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30203){var _e__27201__auto__ = e30203;
return false;
}})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
}catch (e30205){var _e__27201__auto__ = e30205;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30207 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30208 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30208);

try{var map__30209 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30209__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30207);
}});
...
var temp__5733__auto___30233 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___30233)){
var managed_print_level_30234 = temp__5733__auto___30233;
var _STAR_print_level_STAR__orig_val__30212_30235 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30213_30236 = managed_print_level_30234;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30213_30236);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30211_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30211_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30212_30235);
}} else {
job_fn();
}
