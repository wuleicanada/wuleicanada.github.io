...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_30652 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_30652(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_30653 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_30653(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30654 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30654(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30655 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30655(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30659 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30659(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30660 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30660(reader);
}
});
