...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31139 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31139(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31140 = (function (port,val,fn1_handler){
var x__4422__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31140(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31141 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31141(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31150 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31150(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31152 = (function (h){
var x__4422__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31152(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_31157 = (function (h){
var x__4422__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_31157(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31162 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31162(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31167 = (function (b){
var x__4422__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31167(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31172 = (function (b,itm){
var x__4422__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31172(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31184 = (function (b){
var x__4422__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31184(b);
}
});
